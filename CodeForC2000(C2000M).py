...
#Версия скрипт
CodeForC2000Version = '1.3.2'

#Исправлено в ver.1.3.2
#--------------------
#1.Подправил вывод результатов работы в месте где выводится процент выполнения.
...
#2.Рассмотреть возможность сохранения результатов работы в файл.
#3.Рассмотреть возможность продолжения работы с момента последней записи в файл.
