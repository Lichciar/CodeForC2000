...
#Временное прекращение: 21 декабря 2015 г. 02:44

#Версия скрипт
CodeForC2000Version = '1.4.2'

#Исправлено в ver.1.4.2
#--------------------
#1.В версии 1.4.1 проверено - наличие комментариев в скрипте не влияет на производительность.

#План работ на ver.1.X
#---------------------
#1.Рассмотреть возможность сохранения результатов работы в файл.
#2.Рассмотреть возможность продолжения работы с момента последней записи в файл.
